...
const CollapsibleContentClass = require("../src/collapsible_content");
...
describe("collapsible content module", function() {
  ...
  beforeEach(() => {
    ...
    // this.bodyContainer = collapsibleContent.config.element.querySelector("." + collapsibleContent.config.bodyContainerClass);
    // this.navContainer = collapsibleContent.config.element.querySelector("." + collapsibleContent.config.navContainerClass);
  ...
  describe("_getBodies function", () => {
    ...
    it("should build the this.bodies array according to the length of this.items", () => {
  ...
  describe("_init function", () => {
    beforeEach(() => {
      spyOn(collapsibleContent, "render");
    ...
    it("should call the render function", () => {
      expect(collapsibleContent.render).toHaveBeenCalled();
    });
  });
